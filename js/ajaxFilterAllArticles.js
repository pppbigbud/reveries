document.addEventListener("DOMContentLoaded", function () {
  ...
  function filterContent1(selector, actionName, dataKey, initialCategory) {
    ...
    // Charger initialement les articles de la catégorie spécifiée
    if (initialCategory) {
      console.log(ajax_object.ajaxurl);
      var initialCategoryLink = document.querySelector(
        `[${dataKey}="${initialCategory}"]`
      );
      if (initialCategoryLink) {
        initialCategoryLink.click();
      }
    }
  }
});
